  ...
  theme: {
    ...
    extend: {
      ...
      typography: {
        DEFAULT: {
          css: {
            '--tw-prose-body': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
            '--tw-prose-text-body': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
            '--tw-prose-headings': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
            '--tw-prose-lead': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
            '--tw-prose-links': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
            '--tw-prose-bold': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
            ...
            '--tw-prose-code': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
            '--tw-prose-pre-code': 'rgb(var(--color-button-dimmed) / <alpha-value>)',
