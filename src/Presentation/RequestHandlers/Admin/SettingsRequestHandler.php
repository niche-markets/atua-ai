...
#[Route(
    path: '/settings/[general|brand|billing|payments|credits|rate-providers|openai|cohere|anthropic|elevenlabs|stabilityai|gcp|azure|clipdrop|serper|onesignal|mail|smtp|policies|accounts|public-details|recaptcha|appearance|pwa|storage|cdn:name]?',
...
#[Route(
    path: '/settings/[features:group]/[writer|chat|voiceover|imagine|rest-api:name]?',
    method: RequestMethod::GET
)]
