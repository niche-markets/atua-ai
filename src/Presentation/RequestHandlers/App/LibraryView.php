...
#[Route(path: '/library/[documents|code-documents|images|transcriptions|speeches|conversations|isolated-voices|classifications:view]?', method: RequestMethod::GET)]
